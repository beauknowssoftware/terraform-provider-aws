...
func Provider() terraform.ResourceProvider {
	...
	provider := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"aws_apigatewayv2_route":                                  resourceAwsApiGateway2Route(),
			"aws_apigatewayv2_stage":                                  resourceAwsApiGateway2Stage(),
			"aws_apigatewayv2_vpc_link":                               resourceAwsApiGateway2VpcLink(),
